  ...
  const projects = ref([
    {
      ...
      images: ['/src/modules/assets/gym-elegance/admin/panel-administrador.jpg', 
               '/src/modules/assets/gym-elegance/user/agenda-actividades-usuario.jpg',
               '/src/modules/assets/gym-elegance/user/pantalla-home.jpg',
               '/src/modules/assets/gym-elegance/user/pantalla-perfil-usuario.jpg',
               '/src/modules/assets/gym-elegance/user/responsividad-pantalla.jpg',
               '/src/modules/assets/gym-elegance/coach/pantalla-actividades-coach.jpg',
              ],
    },
    {
      id: 2,
      ...
      productionLink: 'https://proyecto2.com',
